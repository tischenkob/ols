...
read_ols_initialize_options :: proc(config: ^common.Config, ols_config: OlsConfig, uri: common.Uri) {
	...
	config.enable_code_action_fill_struct =
	...
	config.enable_code_action_add_ok_result =
		ols_config.enable_code_action_add_ok_result.(bool) or_else config.enable_code_action_add_ok_result
	config.enable_code_action_defer_delete =
		ols_config.enable_code_action_defer_delete.(bool) or_else config.enable_code_action_defer_delete
	config.enable_code_action_extract_constant =
	...
	config.enable_code_action_merge_cases =
	...
	config.enable_code_action_comment =
		ols_config.enable_code_action_comment.(bool) or_else config.enable_code_action_comment
	...
	config.enable_lint_loops = ols_config.enable_lint_loops.(bool) or_else config.enable_lint_loops
	...
	config.enable_lint_recursion = ols_config.enable_lint_recursion.(bool) or_else config.enable_lint_recursion
